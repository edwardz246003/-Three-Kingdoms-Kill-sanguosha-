    ...
    :QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    systray = NULL;
    connect(ui->actionBack, SIGNAL(triggered()), this, SLOT(startGameInAnotherInstance()));
}
...
{
    // Cao Cao's pixmap
    QString content =  "<center><img src='image/generals/small/tianjie.png'> <br /> </center>";
    ...
    content.append(tr("This is the open source clone of the popular <b>Sanguosha</b> game,"
                      ...
                      "My Email: 646700438@qq.com;246003@qq.com <br/>"));
    ...
    QString project_url = "http://renren.com/edwardz";
    content.append(tr("Project home: <a href='%1'>%1</a> <br/>").arg(project_url));

    QString forum_url = "http://weibo.com/evilniang";
...
{
    QString content =  "<center><img src='image/system/logo1.png'> <br /> </center>";

    content.append(tr("This is the open source clone of the popular <b>QSanguosha</b> game,"
                      "totally written in C++ Qt GUI framework <br />"));
    ...
    Window *window = new Window(tr("Thanks to Moligaloo"), QSize(365, 411));
    scene->addItem(window);
...
void MainWindow::on_actionExpand_dashboard_triggered()
{

}

void MainWindow::on_actionRevive_wand_activated()
{
...
void MainWindow::on_actionStart_Game_triggered(bool checked)
{
