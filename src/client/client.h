...
public:
    ...
    void doKaihei(const QString &gongxin_str);
    ...
    void askForBaqi1(const QString &skill_name);
    void askForBaqi2(const QString &skill_name);
    ...
    void askForSuits(const QString &);
...
signals:
    ...
    void kaihei(const QList<int> &card_ids, bool enable_heart);
