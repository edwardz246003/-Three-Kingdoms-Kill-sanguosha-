...
public:
    ...
    void display(JudgeStruct &display_struct);
    ...
    void doKaihei(ServerPlayer *siniang, ServerPlayer *target);
    int drawCard();
    const Card *peek();
    ...
    QString askForSuits(ServerPlayer *player);
    ...
    bool askForBaqi1(ServerPlayer *player, const QString &skill_name, const QVariant &data = QVariant());
    bool askForBaqi2(ServerPlayer *player, const QString &skill_name, const QVariant &data = QVariant());
