    ...
    main_window(main_window), skill_dock(NULL)
{
    ...
    connect(ClientInstance, SIGNAL(kaihei(QList<int>, bool)), this, SLOT(doKaihei(QList<int>, bool)));
...
void RoomScene::doKaihei(const QList<int> &card_ids, bool enable_heart){
    card_container->fillCards(card_ids);
    card_container->startKaihei();
}
